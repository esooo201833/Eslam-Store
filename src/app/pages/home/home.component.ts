          ...
          <div class="relative min-h-screen">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              @for (product of filteredProducts; track product.id) {
                <div class="card-modern overflow-hidden group cursor-pointer shine-effect" (click)="goToProduct(product.id)">
                  <div class="relative overflow-hidden">
                    ...
                    <button
                      ...
                      class="absolute top-4 right-4 p-2 bg-white/90 backdrop-blur-sm rounded-full hover:bg-white transition-all hover:scale-110 shadow-lg"
                    >
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <button
                        ...
                        class="btn-modern btn-modern-accent px-6 py-3 text-white rounded-xl font-semibold"
                      >
                        Add to Cart
                      </button>
                    </div>
                  ...
                  <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                      <span class="text-2xl font-bold text-gradient">\${{ product.price.toFixed(2) }}</span>
                      <button
                        (click)="addToCart($event, product)"
                        class="btn-modern btn-modern-primary p-2 rounded-xl"
                      >
