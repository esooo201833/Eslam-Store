  ...
  template: `
    <div class="min-h-screen flex flex-col" style="background-color: var(--color-bg-secondary)">
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div class="glass-card bg-white/90 dark:bg-gray-900/90 rounded-2xl shadow-2xl p-6 mb-12">
          <div class="flex flex-col md:flex-row gap-4">
            <div class="flex-1 relative">
              ...
              <input
                ...
                class="input-modern pl-12 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-gray-200 dark:border-gray-700"
              />
            </div>
            <select
              id="home-category"
              ...
              class="input-modern cursor-pointer bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-gray-200 dark:border-gray-700"
            >
        ...
        <div class="flex flex-wrap gap-3 mb-8">
          ...
          @for (category of categories; track category) {
            <button
              ...
              class="badge px-6 py-2 text-sm bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-indigo-500 dark:hover:border-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-400 transition-all"
            >
              {{ translateCategory(category) }}
            </button>
          }
                  ...
                  <div class="relative overflow-hidden h-72">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                      <button
                        ...
                        class="px-8 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-bold rounded-2xl shadow-2xl hover:bg-gray-900 dark:hover:bg-gray-700 hover:text-white transition-all duration-300 transform hover:scale-105"
                      >
