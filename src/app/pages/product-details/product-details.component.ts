  ...
  template: `
    <div class="min-h-screen bg-gray-50">
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex items-center border border-gray-300 rounded-lg">
                ...
                <span class="px-4 py-2 min-w-[60px] text-center">{{ quantity }}</span>
                <button
            ...
            <button
              ...
              class="w-full bg-black text-white py-4 rounded-lg font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      @if (!loading && !product) {
        ...
        <button
          routerLink="/"
          class="mt-4 text-black hover:underline"
        >
          Return to Store
        </button>
      </div>
